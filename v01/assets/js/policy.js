...
(function($) {
        ...
        ! function() {
            //chnaging both sidebar width dynamically
              ...
              function setLeftImage(left, top, img_index){
                  ...
                  $(".left-sidebar").append("<a href='"+linksArray[img_index]+"'><img index='"+img_index+"' src='"+baseURL+truck_img_folder_name+"/trucks_light/" + imageName + ".png'></a>");
                  $(".left-sidebar a").last().css({"top": top + "px", "left": left + "px"});
              }

              function setRightImage(right, top, img_index){
                  var imageName = imgsArray[img_index];
                  $(".right-sidebar").append("<a href='"+linksArray[img_index]+"'><img index='"+img_index+"' src='"+baseURL+truck_img_folder_name+"/trucks_light/" + imageName + ".png'></a>");
              ...
              while( top<leftHeight){
                ...
                $('.left-sidebar a img, .right-sidebar a img').mouseenter(function(){
                    ...
                    $(this).attr('src', baseURL+truck_img_folder_name+'/trucks/' + imgsArray[img_index] + '.png')
                });
    ...
    // Policy Text colour
    if($("#pTextHeadingColor")){
        var pTextHeadingColor = $("#pTextHeadingColor").data("color");
        $(".policy_content section h2, .policy_content section h3").css('color', pTextHeadingColor);
    }
